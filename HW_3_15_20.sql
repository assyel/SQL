...
left join employee_salary on employee_salary.salary_id = roles_employee.id 
left join salary on salary.id = roles.id 
where role_name like '%Java Dev%';
...
left join employee_salary on employee_salary.salary_id = roles_employee.role_id 
left join salary on salary.id = roles.id
where role_name like '%Python%';
...
from roles_employee  
left join roles on roles.id = roles_employee.role_id
left join employee_salary on employee_salary.salary_id = roles_employee.employee_id 
