...
where role_name like '%Middle Javascript%';
 ...
 --19. ВРОДЕ ПРАВИЛЬНО Вывести имена и зарплаты Senior Java разработчиков
select  employee_name, role_name,  monthly_salary
from employees
 join roles_employee on employees.id = roles_employee.employee_id 
 join roles on roles.id = roles_employee.role_id 
...
where role_name like 'Junior % QA Engineer';
 ...
 --21. НЕПОНЯТНО Вывести среднюю зарплату всех Junior специалистов
select role_name, avg(monthly_salary) as avg_salary 
from employees   
left  join roles_employee on roles_employee.employee_id = employees.id
left  join roles on roles.id = roles_employee.role_id 
left  join employee_salary on employee_salary.employee_id = roles_employee.employee_id 
...
where role_name like '%Javascript%';
 ...
 --23. НЕПРАВИЛЬНО Вывести минимальную ЗП QA инженеров
select role_name, min(monthly_salary) as min_sal 
from employees 
left join roles_employee on employees.id = roles_employee.employee_id 
left join roles on roles_employee.role_id = roles.id
left join employee_salary on roles_employee.employee_id = employee_salary.employee_id 
...
group by roles.role_name;
 ...
 --24. НЕПРАВИЛЬНО Вывести максимальную ЗП QA инженеров
select role_name, max(monthly_salary) as max_sal 
from employees 
left join roles_employee on roles_employee.employee_id = employees.id 
left join roles on roles_employee.role_id = roles.id
left join employee_salary on employee_salary.employee_id = roles_employee.employee_id 
...
group by roles.role_name;
 ...
 --28. ПРАВИЛЬНО Вывести фонд (сумму) зарплаты разработчиков.ПРАВИЛЬНО
...
where role_name like '%Developer%';
 ...
 --29. НЕПРАВИЛЬНО Вывести имена, должности и ЗП всех специалистов по возрастанию
select  employee_name, role_name, monthly_salary
from employees 
left join roles_employee on roles_employee.employee_id = employees.id
left join roles on roles_employee.role_id = roles.id
...
order by monthly_salary asc;
 ...
 --30. НЕПРАВИЛЬНО Вывести имена, должности и ЗП всех специалистов по возрастанию у специалистов у которых ЗП от 1700 до 2300
select employee_name, role_name, monthly_salary
from employees
left join roles_employee on employees.id = roles_employee.employee_id 
left join roles on roles_employee.role_id = roles.id
...
order by monthly_salary asc; 
 ...
 --31. НЕПРАВИЛЬНО Вывести имена, должности и ЗП всех специалистов по возрастанию у специалистов у которых ЗП меньше 2300
select employee_name, role_name, monthly_salary
from employees
 join roles_employee on employees.id = roles_employee.employee_id
join roles on roles_employee.role_id = roles.id
...
order by monthly_salary asc;
 ...
 --32. НЕ ЗНАЮ ПРАИЛЬНО ИЛИ НЕТ Вывести имена, должности и ЗП всех специалистов по возрастанию у специалистов у которых ЗП равна 1100, 1500, 2000
 select employee_name, role_name, monthly_salary
from employees
left join roles_employee on employees.id = roles_employee.employee_id
left join roles on roles_employee.role_id = roles.id
